                            ...
                            children: [
                              ...
                              ReusableTxtFormFieldNewTransactionCategory(
                                ...
                                validator: (x) {
                                  ...
                                  double valueParsing = double.parse(x);
                                  if (valueParsing <= 0 ||
                                      x.contains('.') &&
                                          x.split('.')[1].length > 2) {
                                    return AppLocalizations.of(context)!
                              ...
                              ReusableTxtFormFieldNewTransactionCategory(
                                ...
                                onTap: () async {
                                  ...
                                  DateTime? pickedDate = await showDatePicker(
                                    context: context,
                                    initialDate:
                                        DateTime.now(), //muestra el inicial
                                    firstDate: DateTime(
                                        2020, 1, 1), //1 de enero de 2020
                                    lastDate: DateTime(
                              ...
                              ReusableButton(
                                  ...
                                  buttonHeight: 0.075,
                                  buttonWidth: 0.3,
                                  colorBorderButton: 'textBlackWhite',
                                  child: isSaving
